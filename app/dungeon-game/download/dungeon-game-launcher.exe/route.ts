// Serves the Dungeon Game Windows launcher over Vercel's TLS. Chrome blocks
...
const ORIGIN =
  'http://143.198.244.74:8081/dungeon-game-launcher-windows-amd64.exe';
...
const FILENAME = 'Dungeon Game Launcher.exe';
